...
static CSTRDEF standardchar[] = {
    ...
    { V('*','z'), 1, "&zeta;"},
    { V('+','-'), 1, "&#177;" },
    { V('+','f'), 3, "&phi;"}, // phi1, we use the standard phi
    { V('+','h'), 5, "&theta;"}, // theta1, we use the standard theta
    { V('+','p'), 2, "&omega;"}, // omega1, we use the standard omega
    { V('1','2'), 1, "&#189;" },
    { V('1','4'), 1, "&#188;" },
    { V('3','4'), 1, "&#190;" },
    { V('F','i'), 3, "ffi" },
    ...
    { V('a','p'), 1, "~" },
    { V('b','r'), 1, "|" },
    { V('b','u'), 1, "<li></li>" }, // ### FIXME: bullet exists in Unicode too
    { V('b','v'), 1, "|" },
    { V('c','i'), 1, "o" }, // ### FIXME: circle
    { V('c','o'), 1, "&#169;" },
    { V('c','t'), 1, "&#162;" },
    { V('d','e'), 1, "&#176;" },
    { V('d','g'), 1, "+" },
