...
/* Encodes input (UINT4) into output (unsigned char). Assumes len is
  a multiple of 4.
 */
static void Encode (unsigned char * output, UINT4 * input, unsigned long int len)
{
...
static void MD5_memcpy (POINTER output, POINTER input, unsigned long int len)
{
    memcpy((void *)output, (void *)input, len);
}

/* Note: Replace "for loop" with standard memset if possible.
 */
static void MD5_memset (POINTER output, int value, unsigned long int len)
{
