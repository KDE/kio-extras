...
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst _tc_LinkName; };
#else
CORBA::TypeCodeConst CosTrading::_tc_LinkName;
#endif

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst _tc_LinkNameSeq; };
#else
CORBA::TypeCodeConst CosTrading::_tc_LinkNameSeq;
#endif

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst _tc_TraderName; };
#else
CORBA::TypeCodeConst CosTrading::_tc_TraderName;
#endif
...
{
  CosTrading::TraderComponents_ptr _o;
  if( !CORBA::is_nil( _obj ) ) {
    void *_p;
    ...
    if( _narrow_helper2( _obj ) ) {
      _o = new CosTrading::TraderComponents_stub;
...
CosTrading::Lookup_ptr CosTrading::TraderComponents_stub::lookup_if()
{
  CORBA::Request_var _req = this->_request( "_get_lookup_if" );
  _req->result()->value()->type( CosTrading::_tc_Lookup );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  ...
  #endif
  CosTrading::Lookup_ptr _res;
  *_req->result()->value() >>= (CosTrading::Lookup_ptr&) _res;
  return _res;
}


CosTrading::Register_ptr CosTrading::TraderComponents_stub::register_if()
{
  CORBA::Request_var _req = this->_request( "_get_register_if" );
  _req->result()->value()->type( CosTrading::_tc_Register );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Register_ptr _res;
  *_req->result()->value() >>= (CosTrading::Register_ptr&) _res;
  return _res;
}


CosTrading::Link_ptr CosTrading::TraderComponents_stub::link_if()
{
  CORBA::Request_var _req = this->_request( "_get_link_if" );
  _req->result()->value()->type( CosTrading::_tc_Link );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Link_ptr _res;
  *_req->result()->value() >>= (CosTrading::Link_ptr&) _res;
  return _res;
}


CosTrading::Proxy_ptr CosTrading::TraderComponents_stub::proxy_if()
{
  CORBA::Request_var _req = this->_request( "_get_proxy_if" );
  _req->result()->value()->type( CosTrading::_tc_Proxy );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Proxy_ptr _res;
  *_req->result()->value() >>= (CosTrading::Proxy_ptr&) _res;
  return _res;
}


CosTrading::Admin_ptr CosTrading::TraderComponents_stub::admin_if()
{
  CORBA::Request_var _req = this->_request( "_get_admin_if" );
  _req->result()->value()->type( CosTrading::_tc_Admin );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Admin_ptr _res;
  *_req->result()->value() >>= (CosTrading::Admin_ptr&) _res;
  return _res;
}


CosTrading::TraderComponents_stub::~TraderComponents_stub()
{
}
...
{
  CosTrading::SupportAttributes_ptr _o;
  if( !CORBA::is_nil( _obj ) ) {
    void *_p;
    ...
    if( _narrow_helper2( _obj ) ) {
      _o = new CosTrading::SupportAttributes_stub;
      _o->CORBA::Object::operator=( *_obj );
      return _o;
    }
  }
...
CORBA::Boolean CosTrading::SupportAttributes_stub::supports_modifiable_properties()
{
  CORBA::Request_var _req = this->_request( "_get_supports_modifiable_properties" );
...
CORBA::Boolean CosTrading::SupportAttributes_stub::supports_dynamic_properties()
{
  CORBA::Request_var _req = this->_request( "_get_supports_dynamic_properties" );
  _req->result()->value()->type( CORBA::_tc_boolean );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::Boolean CosTrading::SupportAttributes_stub::supports_proxy_offers()
{
  CORBA::Request_var _req = this->_request( "_get_supports_proxy_offers" );
  _req->result()->value()->type( CORBA::_tc_boolean );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CosTrading::TypeRepository_ptr CosTrading::SupportAttributes_stub::type_repos()
{
  CORBA::Request_var _req = this->_request( "_get_type_repos" );
  _req->result()->value()->type( CosTrading::_tc_TypeRepository );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::TypeRepository_ptr _res;
  *_req->result()->value() >>= CORBA::Any::to_object( _res );
  return _res;
}


CosTrading::SupportAttributes_stub::~SupportAttributes_stub()
{
}
...
{
  CosTrading::ImportAttributes_ptr _o;
  if( !CORBA::is_nil( _obj ) ) {
    void *_p;
    ...
    if( _narrow_helper2( _obj ) ) {
      _o = new CosTrading::ImportAttributes_stub;
      _o->CORBA::Object::operator=( *_obj );
      return _o;
    }
  }
...
CORBA::ULong CosTrading::ImportAttributes_stub::def_search_card()
{
  CORBA::Request_var _req = this->_request( "_get_def_search_card" );
...
CORBA::ULong CosTrading::ImportAttributes_stub::max_search_card()
{
  CORBA::Request_var _req = this->_request( "_get_max_search_card" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::def_match_card()
{
  CORBA::Request_var _req = this->_request( "_get_def_match_card" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::max_match_card()
{
  CORBA::Request_var _req = this->_request( "_get_max_match_card" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::def_return_card()
{
  CORBA::Request_var _req = this->_request( "_get_def_return_card" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::max_return_card()
{
  CORBA::Request_var _req = this->_request( "_get_max_return_card" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::max_list()
{
  CORBA::Request_var _req = this->_request( "_get_max_list" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::def_hop_count()
{
  CORBA::Request_var _req = this->_request( "_get_def_hop_count" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::ULong CosTrading::ImportAttributes_stub::max_hop_count()
{
  CORBA::Request_var _req = this->_request( "_get_max_hop_count" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CosTrading::FollowOption CosTrading::ImportAttributes_stub::def_follow_policy()
{
  CORBA::Request_var _req = this->_request( "_get_def_follow_policy" );
  _req->result()->value()->type( CosTrading::_tc_FollowOption );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::FollowOption _res;
  *_req->result()->value() >>= _res;
  return _res;
}


CosTrading::FollowOption CosTrading::ImportAttributes_stub::max_follow_policy()
{
  CORBA::Request_var _req = this->_request( "_get_max_follow_policy" );
  _req->result()->value()->type( CosTrading::_tc_FollowOption );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CosTrading::ImportAttributes_stub::~ImportAttributes_stub()
{
}
...
// Stub interface LinkAttributes
CosTrading::LinkAttributes::~LinkAttributes()
{
}

CosTrading::LinkAttributes_ptr CosTrading::LinkAttributes::_duplicate( LinkAttributes_ptr _obj )
{
  if( !CORBA::is_nil( _obj ) )
    _obj->_ref();
  return _obj;
...
void *CosTrading::LinkAttributes::_narrow_helper( const char *_repoid )
{
  if( strcmp( _repoid, "IDL:omg.org/CosTrading/LinkAttributes:1.0" ) == 0 )
    return (void *)this;
  return NULL;
}

bool CosTrading::LinkAttributes::_narrow_helper2( CORBA::Object_ptr _obj )
{
  if( strcmp( _obj->_repoid(), "IDL:omg.org/CosTrading/LinkAttributes:1.0" ) == 0) {
    return true;
  }
  for( vector<CORBA::Narrow_proto>::size_type _i = 0;
       _narrow_helpers && _i < _narrow_helpers->size(); _i++ ) {
...
CosTrading::LinkAttributes_ptr CosTrading::LinkAttributes::_narrow( CORBA::Object_ptr _obj )
{
  CosTrading::LinkAttributes_ptr _o;
  if( !CORBA::is_nil( _obj ) ) {
    void *_p;
    if( (_p = _obj->_narrow_helper( "IDL:omg.org/CosTrading/LinkAttributes:1.0" )))
      return _duplicate( (CosTrading::LinkAttributes_ptr) _p );
    if( _narrow_helper2( _obj ) ) {
      _o = new CosTrading::LinkAttributes_stub;
      _o->CORBA::Object::operator=( *_obj );
      return _o;
    }
  }
...
CosTrading::LinkAttributes_ptr CosTrading::LinkAttributes::_nil()
{
  return NULL;
}

CosTrading::FollowOption CosTrading::LinkAttributes_stub::max_link_follow_policy()
{
  CORBA::Request_var _req = this->_request( "_get_max_link_follow_policy" );
  _req->result()->value()->type( CosTrading::_tc_FollowOption );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CosTrading::LinkAttributes_stub::~LinkAttributes_stub()
{
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { vector<CORBA::Narrow_proto> * LinkAttributes::_narrow_helpers; };
#else
vector<CORBA::Narrow_proto> * CosTrading::LinkAttributes::_narrow_helpers;
#endif
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst _tc_LinkAttributes; };
#else
CORBA::TypeCodeConst CosTrading::_tc_LinkAttributes;
#endif

CORBA::Boolean
operator<<=( CORBA::Any &_a, const CosTrading::LinkAttributes_ptr _obj )
{
  return (_a <<= CORBA::Any::from_object( _obj, "LinkAttributes" ));
}

CORBA::Boolean
operator>>=( const CORBA::Any &_a, CosTrading::LinkAttributes_ptr &_obj )
{
  CORBA::Object_ptr _o;
  if( !(_a >>= CORBA::Any::to_object( _o )) )
    return FALSE;
  if( CORBA::is_nil( _o ) ) {
    _obj = ::CosTrading::LinkAttributes::_nil();
    return TRUE;
  }
  _obj = ::CosTrading::LinkAttributes::_narrow( _o );
  CORBA::release( _o );
  return TRUE;
}
...
CosTrading::Lookup_stub::~Lookup_stub()
{
}

void CosTrading::Lookup_stub::query( const char* type, const char* constr, const char* pref, const CosTrading::PolicySeq& policies, const CosTrading::Lookup::SpecifiedProps& desired_props, CORBA::ULong how_many, CosTrading::OfferSeq*& offers, CosTrading::OfferIterator_ptr& offer_itr, CosTrading::PolicyNameSeq*& limits_applied )
{
  CORBA::Request_var _req = this->_request( "query" );
  _req->add_in_arg( "type" ) <<= CORBA::Any::from_string( (char *) type, 0 );
  _req->add_in_arg( "constr" ) <<= CORBA::Any::from_string( (char *) constr, 0 );
  _req->add_in_arg( "pref" ) <<= CORBA::Any::from_string( (char *) pref, 0 );
  _req->add_in_arg( "policies" ) <<= policies;
  _req->add_in_arg( "desired_props" ) <<= desired_props;
  _req->add_in_arg( "how_many" ) <<= how_many;
  _req->add_out_arg( "offers" );
  _req->arguments()->item( 6 )->value()->type( CosTrading::_tc_OfferSeq );
  _req->add_out_arg( "offer_itr" );
  _req->arguments()->item( 7 )->value()->type( CosTrading::_tc_OfferIterator );
  _req->add_out_arg( "limits_applied" );
  _req->arguments()->item( 8 )->value()->type( CosTrading::_tc_PolicyNameSeq );
  ...
  if( _req->env()->exception() ) {
    ...
    if( _uuex ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/IllegalConstraint:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_IllegalConstraint );
        ::CosTrading::IllegalConstraint _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Lookup/IllegalPreference:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Lookup::_tc_IllegalPreference );
        ::CosTrading::Lookup::IllegalPreference _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Lookup/IllegalPolicyName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Lookup::_tc_IllegalPolicyName );
        ::CosTrading::Lookup::IllegalPolicyName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Lookup/PolicyTypeMismatch:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Lookup::_tc_PolicyTypeMismatch );
        ::CosTrading::Lookup::PolicyTypeMismatch _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Lookup/InvalidPolicyValue:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Lookup::_tc_InvalidPolicyValue );
        ::CosTrading::Lookup::InvalidPolicyValue _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/DuplicatePolicyName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_DuplicatePolicyName );
        ::CosTrading::DuplicatePolicyName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
  ...
  *_req->arguments()->item( 6 )->value() >>= *offers;
  *_req->arguments()->item( 7 )->value() >>= (CosTrading::OfferIterator_ptr&) offer_itr;
  limits_applied = new ::CosTrading::PolicyNameSeq;
  *_req->arguments()->item( 8 )->value() >>= *limits_applied;
}
...
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_OfferInfo; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_OfferInfo;
#endif

#ifdef HAVE_EXPLICIT_STRUCT_OPS
CosTrading::Register::OfferInfo::OfferInfo()
{
}

CosTrading::Register::OfferInfo::OfferInfo( const OfferInfo& _s )
{
  reference = ((OfferInfo&)_s).reference;
  type = ((OfferInfo&)_s).type;
  properties = ((OfferInfo&)_s).properties;
}
...
CosTrading::Register::OfferInfo::operator=( const OfferInfo& _s )
{
  reference = ((OfferInfo&)_s).reference;
  type = ((OfferInfo&)_s).type;
  properties = ((OfferInfo&)_s).properties;
...
{
  _a.type( CosTrading::Register::_tc_OfferInfo );
  return (_a.struct_put_begin() &&
    (_a <<= CORBA::Any::from_object( ((CosTrading::Register::OfferInfo&)_s).reference, "Object" )) &&
    (_a <<= ((CosTrading::Register::OfferInfo&)_s).type) &&
    (_a <<= ((CosTrading::Register::OfferInfo&)_s).properties) &&
    _a.struct_put_end() );
}
...
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_UnknownPropertyName; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_UnknownPropertyName;
#endif
...
CosTrading::Register::UnknownPropertyName::UnknownPropertyName( const UnknownPropertyName& _s )
{
  name = ((UnknownPropertyName&)_s).name;
}
...
CosTrading::Register::UnknownPropertyName::operator=( const UnknownPropertyName& _s )
{
  name = ((UnknownPropertyName&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::UnknownPropertyName &_e )
{
  _a.type( CosTrading::Register::_tc_UnknownPropertyName );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/UnknownPropertyName:1.0" ) &&
    (_a <<= ((CosTrading::Register::UnknownPropertyName&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::UnknownPropertyName &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Register::UnknownPropertyName::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw UnknownPropertyName_var( (CosTrading::Register::UnknownPropertyName*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::UnknownPropertyName::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/UnknownPropertyName:1.0";
}

void CosTrading::Register::UnknownPropertyName::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::UnknownPropertyName::_clone() const
{
  return new UnknownPropertyName( *this );
}

CosTrading::Register::UnknownPropertyName *CosTrading::Register::UnknownPropertyName::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/UnknownPropertyName:1.0" ) )
    return (UnknownPropertyName *) _ex;
  return NULL;
}
...
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_ProxyOfferId; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_ProxyOfferId;
#endif
...
CosTrading::Register::ProxyOfferId::ProxyOfferId( const ProxyOfferId& _s )
{
  id = ((ProxyOfferId&)_s).id;
}
...
CosTrading::Register::ProxyOfferId::operator=( const ProxyOfferId& _s )
{
  id = ((ProxyOfferId&)_s).id;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::ProxyOfferId &_e )
{
  _a.type( CosTrading::Register::_tc_ProxyOfferId );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/ProxyOfferId:1.0" ) &&
    (_a <<= ((CosTrading::Register::ProxyOfferId&)_e).id) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::ProxyOfferId &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.id) &&
...
void CosTrading::Register::ProxyOfferId::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw ProxyOfferId_var( (CosTrading::Register::ProxyOfferId*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::ProxyOfferId::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/ProxyOfferId:1.0";
}

void CosTrading::Register::ProxyOfferId::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::ProxyOfferId::_clone() const
{
  return new ProxyOfferId( *this );
}

CosTrading::Register::ProxyOfferId *CosTrading::Register::ProxyOfferId::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/ProxyOfferId:1.0" ) )
    return (ProxyOfferId *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_MandatoryProperty; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_MandatoryProperty;
#endif
...
CosTrading::Register::MandatoryProperty::MandatoryProperty( const MandatoryProperty& _s )
{
  type = ((MandatoryProperty&)_s).type;
  name = ((MandatoryProperty&)_s).name;
}
...
CosTrading::Register::MandatoryProperty::operator=( const MandatoryProperty& _s )
{
  type = ((MandatoryProperty&)_s).type;
  name = ((MandatoryProperty&)_s).name;
  return *this;
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::MandatoryProperty &_e )
{
  _a.type( CosTrading::Register::_tc_MandatoryProperty );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/MandatoryProperty:1.0" ) &&
    (_a <<= ((CosTrading::Register::MandatoryProperty&)_e).type) &&
    (_a <<= ((CosTrading::Register::MandatoryProperty&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::MandatoryProperty &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.type) &&
...
void CosTrading::Register::MandatoryProperty::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw MandatoryProperty_var( (CosTrading::Register::MandatoryProperty*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::MandatoryProperty::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/MandatoryProperty:1.0";
}

void CosTrading::Register::MandatoryProperty::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::MandatoryProperty::_clone() const
{
  return new MandatoryProperty( *this );
}

CosTrading::Register::MandatoryProperty *CosTrading::Register::MandatoryProperty::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/MandatoryProperty:1.0" ) )
    return (MandatoryProperty *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_ReadonlyProperty; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_ReadonlyProperty;
#endif
...
CosTrading::Register::ReadonlyProperty::ReadonlyProperty( const ReadonlyProperty& _s )
{
  type = ((ReadonlyProperty&)_s).type;
  name = ((ReadonlyProperty&)_s).name;
}
...
CosTrading::Register::ReadonlyProperty::operator=( const ReadonlyProperty& _s )
{
  type = ((ReadonlyProperty&)_s).type;
  name = ((ReadonlyProperty&)_s).name;
  return *this;
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::ReadonlyProperty &_e )
{
  _a.type( CosTrading::Register::_tc_ReadonlyProperty );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/ReadonlyProperty:1.0" ) &&
    (_a <<= ((CosTrading::Register::ReadonlyProperty&)_e).type) &&
    (_a <<= ((CosTrading::Register::ReadonlyProperty&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::ReadonlyProperty &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.type) &&
...
void CosTrading::Register::ReadonlyProperty::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw ReadonlyProperty_var( (CosTrading::Register::ReadonlyProperty*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::ReadonlyProperty::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/ReadonlyProperty:1.0";
}

void CosTrading::Register::ReadonlyProperty::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::ReadonlyProperty::_clone() const
{
  return new ReadonlyProperty( *this );
}

CosTrading::Register::ReadonlyProperty *CosTrading::Register::ReadonlyProperty::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/ReadonlyProperty:1.0" ) )
    return (ReadonlyProperty *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_NoMatchingOffers; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_NoMatchingOffers;
#endif
...
CosTrading::Register::NoMatchingOffers::NoMatchingOffers( const NoMatchingOffers& _s )
{
  constr = ((NoMatchingOffers&)_s).constr;
}
...
CosTrading::Register::NoMatchingOffers::operator=( const NoMatchingOffers& _s )
{
  constr = ((NoMatchingOffers&)_s).constr;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::NoMatchingOffers &_e )
{
  _a.type( CosTrading::Register::_tc_NoMatchingOffers );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/NoMatchingOffers:1.0" ) &&
    (_a <<= ((CosTrading::Register::NoMatchingOffers&)_e).constr) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::NoMatchingOffers &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.constr) &&
...
void CosTrading::Register::NoMatchingOffers::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw NoMatchingOffers_var( (CosTrading::Register::NoMatchingOffers*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::NoMatchingOffers::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/NoMatchingOffers:1.0";
}

void CosTrading::Register::NoMatchingOffers::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::NoMatchingOffers::_clone() const
{
  return new NoMatchingOffers( *this );
}

CosTrading::Register::NoMatchingOffers *CosTrading::Register::NoMatchingOffers::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/NoMatchingOffers:1.0" ) )
    return (NoMatchingOffers *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_IllegalTraderName; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_IllegalTraderName;
#endif
...
CosTrading::Register::IllegalTraderName::IllegalTraderName( const IllegalTraderName& _s )
{
  name = ((IllegalTraderName&)_s).name;
}
...
CosTrading::Register::IllegalTraderName::operator=( const IllegalTraderName& _s )
{
  name = ((IllegalTraderName&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::IllegalTraderName &_e )
{
  _a.type( CosTrading::Register::_tc_IllegalTraderName );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/IllegalTraderName:1.0" ) &&
    (_a <<= ((CosTrading::Register::IllegalTraderName&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::IllegalTraderName &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Register::IllegalTraderName::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw IllegalTraderName_var( (CosTrading::Register::IllegalTraderName*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::IllegalTraderName::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/IllegalTraderName:1.0";
}

void CosTrading::Register::IllegalTraderName::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::IllegalTraderName::_clone() const
{
  return new IllegalTraderName( *this );
}

CosTrading::Register::IllegalTraderName *CosTrading::Register::IllegalTraderName::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/IllegalTraderName:1.0" ) )
    return (IllegalTraderName *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_UnknownTraderName; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_UnknownTraderName;
#endif
...
CosTrading::Register::UnknownTraderName::UnknownTraderName( const UnknownTraderName& _s )
{
  name = ((UnknownTraderName&)_s).name;
}
...
CosTrading::Register::UnknownTraderName::operator=( const UnknownTraderName& _s )
{
  name = ((UnknownTraderName&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::UnknownTraderName &_e )
{
  _a.type( CosTrading::Register::_tc_UnknownTraderName );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/UnknownTraderName:1.0" ) &&
    (_a <<= ((CosTrading::Register::UnknownTraderName&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::UnknownTraderName &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Register::UnknownTraderName::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw UnknownTraderName_var( (CosTrading::Register::UnknownTraderName*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::UnknownTraderName::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/UnknownTraderName:1.0";
}

void CosTrading::Register::UnknownTraderName::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::UnknownTraderName::_clone() const
{
  return new UnknownTraderName( *this );
}

CosTrading::Register::UnknownTraderName *CosTrading::Register::UnknownTraderName::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/UnknownTraderName:1.0" ) )
    return (UnknownTraderName *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Register::_tc_RegisterNotSupported; };
#else
CORBA::TypeCodeConst CosTrading::Register::_tc_RegisterNotSupported;
#endif
...
CosTrading::Register::RegisterNotSupported::RegisterNotSupported( const RegisterNotSupported& _s )
{
  name = ((RegisterNotSupported&)_s).name;
}
...
CosTrading::Register::RegisterNotSupported::operator=( const RegisterNotSupported& _s )
{
  name = ((RegisterNotSupported&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Register::RegisterNotSupported &_e )
{
  _a.type( CosTrading::Register::_tc_RegisterNotSupported );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Register/RegisterNotSupported:1.0" ) &&
    (_a <<= ((CosTrading::Register::RegisterNotSupported&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Register::RegisterNotSupported &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Register::RegisterNotSupported::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw RegisterNotSupported_var( (CosTrading::Register::RegisterNotSupported*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Register::RegisterNotSupported::_repoid() const
{
  return "IDL:omg.org/CosTrading/Register/RegisterNotSupported:1.0";
}

void CosTrading::Register::RegisterNotSupported::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Register::RegisterNotSupported::_clone() const
{
  return new RegisterNotSupported( *this );
}

CosTrading::Register::RegisterNotSupported *CosTrading::Register::RegisterNotSupported::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Register/RegisterNotSupported:1.0" ) )
    return (RegisterNotSupported *) _ex;
  return NULL;
}
...
CosTrading::Register_stub::~Register_stub()
{
}

char* CosTrading::Register_stub::export( CORBA::Object_ptr reference, const char* type, const CosTrading::PropertySeq& properties )
{
  CORBA::Request_var _req = this->_request( "export" );
  _req->add_in_arg( "reference" ) <<= CORBA::Any::from_object( reference, "Object" );
  _req->add_in_arg( "type" ) <<= CORBA::Any::from_string( (char *) type, 0 );
  _req->add_in_arg( "properties" ) <<= properties;
  _req->result()->value()->type( CosTrading::_tc_OfferId );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
    CORBA::UnknownUserException *_uuex = CORBA::UnknownUserException::_narrow( _ex );
    if( _uuex ) {
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/InvalidObjectRef:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_InvalidObjectRef );
        ::CosTrading::Register::InvalidObjectRef _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/IllegalServiceType:1.0" ) ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/InterfaceTypeMismatch:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_InterfaceTypeMismatch );
        ::CosTrading::Register::InterfaceTypeMismatch _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/IllegalPropertyName:1.0" ) ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/PropertyTypeMismatch:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_PropertyTypeMismatch );
        ::CosTrading::PropertyTypeMismatch _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/ReadonlyDynamicProperty:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_ReadonlyDynamicProperty );
        ::CosTrading::ReadonlyDynamicProperty _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/MissingMandatoryProperty:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_MissingMandatoryProperty );
        ::CosTrading::MissingMandatoryProperty _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/DuplicatePropertyName:1.0" ) ) {
  ...
  #endif
  CosTrading::OfferId _res;
  *_req->result()->value() >>= _res;
  return _res;
}


void CosTrading::Register_stub::withdraw( const char* id )
{
  CORBA::Request_var _req = this->_request( "withdraw" );
  _req->add_in_arg( "id" ) <<= CORBA::Any::from_string( (char *) id, 0 );
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    CORBA::UnknownUserException *_uuex = CORBA::UnknownUserException::_narrow( _ex );
    if( _uuex ) {
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/IllegalOfferId:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_IllegalOfferId );
        ::CosTrading::IllegalOfferId _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/UnknownOfferId:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_UnknownOfferId );
        ::CosTrading::UnknownOfferId _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/ProxyOfferId:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_ProxyOfferId );
        ::CosTrading::Register::ProxyOfferId _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
CosTrading::Register::OfferInfo* CosTrading::Register_stub::describe( const char* id )
{
  CORBA::Request_var _req = this->_request( "describe" );
  _req->add_in_arg( "id" ) <<= CORBA::Any::from_string( (char *) id, 0 );
  _req->result()->value()->type( CosTrading::Register::_tc_OfferInfo );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Register::OfferInfo* _res = new ::CosTrading::Register::OfferInfo;
  *_req->result()->value() >>= *_res;
  return _res;
}


void CosTrading::Register_stub::modify( const char* id, const CosTrading::PropertyNameSeq& del_list, const CosTrading::PropertySeq& modify_list )
{
  CORBA::Request_var _req = this->_request( "modify" );
  _req->add_in_arg( "id" ) <<= CORBA::Any::from_string( (char *) id, 0 );
  _req->add_in_arg( "del_list" ) <<= del_list;
  _req->add_in_arg( "modify_list" ) <<= modify_list;
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    CORBA::UnknownUserException *_uuex = CORBA::UnknownUserException::_narrow( _ex );
    if( _uuex ) {
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/NotImplemented:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_NotImplemented );
        ::CosTrading::NotImplemented _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/IllegalOfferId:1.0" ) ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/UnknownPropertyName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_UnknownPropertyName );
        ::CosTrading::Register::UnknownPropertyName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/PropertyTypeMismatch:1.0" ) ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/MandatoryProperty:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_MandatoryProperty );
        ::CosTrading::Register::MandatoryProperty _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/ReadonlyProperty:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_ReadonlyProperty );
        ::CosTrading::Register::ReadonlyProperty _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/DuplicatePropertyName:1.0" ) ) {
...
void CosTrading::Register_stub::withdraw_using_constraint( const char* type, const char* constr )
{
  CORBA::Request_var _req = this->_request( "withdraw_using_constraint" );
  _req->add_in_arg( "type" ) <<= CORBA::Any::from_string( (char *) type, 0 );
  _req->add_in_arg( "constr" ) <<= CORBA::Any::from_string( (char *) constr, 0 );
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  ...
  if( _req->env()->exception() ) {
    ...
    if( _uuex ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/NoMatchingOffers:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_NoMatchingOffers );
        ::CosTrading::Register::NoMatchingOffers _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
CosTrading::Register_ptr CosTrading::Register_stub::resolve( const CosTrading::TraderName& name )
{
  CORBA::Request_var _req = this->_request( "resolve" );
  _req->add_in_arg( "name" ) <<= name;
  _req->result()->value()->type( CosTrading::_tc_Register );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    CORBA::UnknownUserException *_uuex = CORBA::UnknownUserException::_narrow( _ex );
    if( _uuex ) {
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/IllegalTraderName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_IllegalTraderName );
        ::CosTrading::Register::IllegalTraderName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/UnknownTraderName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_UnknownTraderName );
        ::CosTrading::Register::UnknownTraderName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Register/RegisterNotSupported:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Register::_tc_RegisterNotSupported );
        ::CosTrading::Register::RegisterNotSupported _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
struct _global_init_CosTrading_Register {
  _global_init_CosTrading_Register()
  {
    if( ::CosTrading::TraderComponents::_narrow_helpers == NULL )
      ::CosTrading::TraderComponents::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::TraderComponents::_narrow_helpers->push_back( CosTrading::Register::_narrow_helper2 );
    if( ::CosTrading::SupportAttributes::_narrow_helpers == NULL )
      ::CosTrading::SupportAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::SupportAttributes::_narrow_helpers->push_back( CosTrading::Register::_narrow_helper2 );
  }
} __global_init_CosTrading_Register;
...
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Link::_tc_LinkInfo; };
#else
CORBA::TypeCodeConst CosTrading::Link::_tc_LinkInfo;
#endif

#ifdef HAVE_EXPLICIT_STRUCT_OPS
CosTrading::Link::LinkInfo::LinkInfo()
{
}

CosTrading::Link::LinkInfo::LinkInfo( const LinkInfo& _s )
{
  target = ((LinkInfo&)_s).target;
  target_reg = ((LinkInfo&)_s).target_reg;
  def_pass_on_follow_rule = ((LinkInfo&)_s).def_pass_on_follow_rule;
  limiting_follow_rule = ((LinkInfo&)_s).limiting_follow_rule;
}
...
CosTrading::Link::LinkInfo::operator=( const LinkInfo& _s )
{
  target = ((LinkInfo&)_s).target;
  target_reg = ((LinkInfo&)_s).target_reg;
  def_pass_on_follow_rule = ((LinkInfo&)_s).def_pass_on_follow_rule;
...
{
  _a.type( CosTrading::Link::_tc_LinkInfo );
  return (_a.struct_put_begin() &&
    (_a <<= (CosTrading::Lookup_ptr) ((CosTrading::Link::LinkInfo&)_s).target) &&
    (_a <<= (CosTrading::Register_ptr) ((CosTrading::Link::LinkInfo&)_s).target_reg) &&
    (_a <<= ((CosTrading::Link::LinkInfo&)_s).def_pass_on_follow_rule) &&
    (_a <<= ((CosTrading::Link::LinkInfo&)_s).limiting_follow_rule) &&
    _a.struct_put_end() );
}
...
{
  return (_a.struct_get_begin() &&
    (_a >>= (CosTrading::Lookup_ptr&) _s.target) &&
    (_a >>= (CosTrading::Register_ptr&) _s.target_reg) &&
    (_a >>= _s.def_pass_on_follow_rule) &&
    (_a >>= _s.limiting_follow_rule) &&
    _a.struct_get_end() );
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Link::_tc_IllegalLinkName; };
#else
CORBA::TypeCodeConst CosTrading::Link::_tc_IllegalLinkName;
#endif
...
CosTrading::Link::IllegalLinkName::IllegalLinkName( const IllegalLinkName& _s )
{
  name = ((IllegalLinkName&)_s).name;
}
...
CosTrading::Link::IllegalLinkName::operator=( const IllegalLinkName& _s )
{
  name = ((IllegalLinkName&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Link::IllegalLinkName &_e )
{
  _a.type( CosTrading::Link::_tc_IllegalLinkName );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Link/IllegalLinkName:1.0" ) &&
    (_a <<= ((CosTrading::Link::IllegalLinkName&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Link::IllegalLinkName &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Link::IllegalLinkName::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw IllegalLinkName_var( (CosTrading::Link::IllegalLinkName*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Link::IllegalLinkName::_repoid() const
{
  return "IDL:omg.org/CosTrading/Link/IllegalLinkName:1.0";
}

void CosTrading::Link::IllegalLinkName::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Link::IllegalLinkName::_clone() const
{
  return new IllegalLinkName( *this );
}

CosTrading::Link::IllegalLinkName *CosTrading::Link::IllegalLinkName::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Link/IllegalLinkName:1.0" ) )
    return (IllegalLinkName *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Link::_tc_UnknownLinkName; };
#else
CORBA::TypeCodeConst CosTrading::Link::_tc_UnknownLinkName;
#endif
...
CosTrading::Link::UnknownLinkName::UnknownLinkName( const UnknownLinkName& _s )
{
  name = ((UnknownLinkName&)_s).name;
}
...
CosTrading::Link::UnknownLinkName::operator=( const UnknownLinkName& _s )
{
  name = ((UnknownLinkName&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Link::UnknownLinkName &_e )
{
  _a.type( CosTrading::Link::_tc_UnknownLinkName );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Link/UnknownLinkName:1.0" ) &&
    (_a <<= ((CosTrading::Link::UnknownLinkName&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Link::UnknownLinkName &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Link::UnknownLinkName::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw UnknownLinkName_var( (CosTrading::Link::UnknownLinkName*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Link::UnknownLinkName::_repoid() const
{
  return "IDL:omg.org/CosTrading/Link/UnknownLinkName:1.0";
}

void CosTrading::Link::UnknownLinkName::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Link::UnknownLinkName::_clone() const
{
  return new UnknownLinkName( *this );
}

CosTrading::Link::UnknownLinkName *CosTrading::Link::UnknownLinkName::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Link/UnknownLinkName:1.0" ) )
    return (UnknownLinkName *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Link::_tc_DuplicateLinkName; };
#else
CORBA::TypeCodeConst CosTrading::Link::_tc_DuplicateLinkName;
#endif
...
CosTrading::Link::DuplicateLinkName::DuplicateLinkName( const DuplicateLinkName& _s )
{
  name = ((DuplicateLinkName&)_s).name;
}
...
CosTrading::Link::DuplicateLinkName::operator=( const DuplicateLinkName& _s )
{
  name = ((DuplicateLinkName&)_s).name;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Link::DuplicateLinkName &_e )
{
  _a.type( CosTrading::Link::_tc_DuplicateLinkName );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Link/DuplicateLinkName:1.0" ) &&
    (_a <<= ((CosTrading::Link::DuplicateLinkName&)_e).name) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Link::DuplicateLinkName &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.name) &&
...
void CosTrading::Link::DuplicateLinkName::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw DuplicateLinkName_var( (CosTrading::Link::DuplicateLinkName*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Link::DuplicateLinkName::_repoid() const
{
  return "IDL:omg.org/CosTrading/Link/DuplicateLinkName:1.0";
}

void CosTrading::Link::DuplicateLinkName::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Link::DuplicateLinkName::_clone() const
{
  return new DuplicateLinkName( *this );
}

CosTrading::Link::DuplicateLinkName *CosTrading::Link::DuplicateLinkName::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Link/DuplicateLinkName:1.0" ) )
    return (DuplicateLinkName *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Link::_tc_DefaultFollowTooPermissive; };
#else
CORBA::TypeCodeConst CosTrading::Link::_tc_DefaultFollowTooPermissive;
#endif
...
CosTrading::Link::DefaultFollowTooPermissive::DefaultFollowTooPermissive( const DefaultFollowTooPermissive& _s )
{
  def_pass_on_follow_rule = ((DefaultFollowTooPermissive&)_s).def_pass_on_follow_rule;
  limiting_follow_rule = ((DefaultFollowTooPermissive&)_s).limiting_follow_rule;
}
...
CosTrading::Link::DefaultFollowTooPermissive::operator=( const DefaultFollowTooPermissive& _s )
{
  def_pass_on_follow_rule = ((DefaultFollowTooPermissive&)_s).def_pass_on_follow_rule;
  limiting_follow_rule = ((DefaultFollowTooPermissive&)_s).limiting_follow_rule;
  return *this;
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Link::DefaultFollowTooPermissive &_e )
{
  _a.type( CosTrading::Link::_tc_DefaultFollowTooPermissive );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Link/DefaultFollowTooPermissive:1.0" ) &&
    (_a <<= ((CosTrading::Link::DefaultFollowTooPermissive&)_e).def_pass_on_follow_rule) &&
    (_a <<= ((CosTrading::Link::DefaultFollowTooPermissive&)_e).limiting_follow_rule) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Link::DefaultFollowTooPermissive &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.def_pass_on_follow_rule) &&
    (_a >>= _e.limiting_follow_rule) &&
    _a.except_get_end() );
}

void CosTrading::Link::DefaultFollowTooPermissive::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw DefaultFollowTooPermissive_var( (CosTrading::Link::DefaultFollowTooPermissive*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Link::DefaultFollowTooPermissive::_repoid() const
{
  return "IDL:omg.org/CosTrading/Link/DefaultFollowTooPermissive:1.0";
}

void CosTrading::Link::DefaultFollowTooPermissive::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Link::DefaultFollowTooPermissive::_clone() const
{
  return new DefaultFollowTooPermissive( *this );
}

CosTrading::Link::DefaultFollowTooPermissive *CosTrading::Link::DefaultFollowTooPermissive::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Link/DefaultFollowTooPermissive:1.0" ) )
    return (DefaultFollowTooPermissive *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Link::_tc_LimitingFollowTooPermissive; };
#else
CORBA::TypeCodeConst CosTrading::Link::_tc_LimitingFollowTooPermissive;
#endif
...
CosTrading::Link::LimitingFollowTooPermissive::LimitingFollowTooPermissive( const LimitingFollowTooPermissive& _s )
{
  limiting_follow_rule = ((LimitingFollowTooPermissive&)_s).limiting_follow_rule;
  max_link_follow_policy = ((LimitingFollowTooPermissive&)_s).max_link_follow_policy;
}
...
CosTrading::Link::LimitingFollowTooPermissive::operator=( const LimitingFollowTooPermissive& _s )
{
  limiting_follow_rule = ((LimitingFollowTooPermissive&)_s).limiting_follow_rule;
  max_link_follow_policy = ((LimitingFollowTooPermissive&)_s).max_link_follow_policy;
  return *this;
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Link::LimitingFollowTooPermissive &_e )
{
  _a.type( CosTrading::Link::_tc_LimitingFollowTooPermissive );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Link/LimitingFollowTooPermissive:1.0" ) &&
    (_a <<= ((CosTrading::Link::LimitingFollowTooPermissive&)_e).limiting_follow_rule) &&
    (_a <<= ((CosTrading::Link::LimitingFollowTooPermissive&)_e).max_link_follow_policy) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Link::LimitingFollowTooPermissive &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.limiting_follow_rule) &&
    (_a >>= _e.max_link_follow_policy) &&
    _a.except_get_end() );
}

void CosTrading::Link::LimitingFollowTooPermissive::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw LimitingFollowTooPermissive_var( (CosTrading::Link::LimitingFollowTooPermissive*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Link::LimitingFollowTooPermissive::_repoid() const
{
  return "IDL:omg.org/CosTrading/Link/LimitingFollowTooPermissive:1.0";
}

void CosTrading::Link::LimitingFollowTooPermissive::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Link::LimitingFollowTooPermissive::_clone() const
{
  return new LimitingFollowTooPermissive( *this );
}

CosTrading::Link::LimitingFollowTooPermissive *CosTrading::Link::LimitingFollowTooPermissive::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Link/LimitingFollowTooPermissive:1.0" ) )
    return (LimitingFollowTooPermissive *) _ex;
  return NULL;
}
...
void *CosTrading::Link::_narrow_helper( const char *_repoid )
{
  ...
  {
    void *_p;
    if( (_p = LinkAttributes::_narrow_helper( _repoid )))
      return _p;
  }
  return NULL;
}
...
CosTrading::Link_stub::~Link_stub()
{
}

void CosTrading::Link_stub::add_link( const char* name, CosTrading::Lookup_ptr target, CosTrading::FollowOption def_pass_on_follow_rule, CosTrading::FollowOption limiting_follow_rule )
{
  CORBA::Request_var _req = this->_request( "add_link" );
  _req->add_in_arg( "name" ) <<= CORBA::Any::from_string( (char *) name, 0 );
  _req->add_in_arg( "target" ) <<= (CosTrading::Lookup_ptr) target;
  _req->add_in_arg( "def_pass_on_follow_rule" ) <<= def_pass_on_follow_rule;
  _req->add_in_arg( "limiting_follow_rule" ) <<= limiting_follow_rule;
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    CORBA::UnknownUserException *_uuex = CORBA::UnknownUserException::_narrow( _ex );
    if( _uuex ) {
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Link/IllegalLinkName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Link::_tc_IllegalLinkName );
        ::CosTrading::Link::IllegalLinkName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Link/DuplicateLinkName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Link::_tc_DuplicateLinkName );
        ::CosTrading::Link::DuplicateLinkName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/InvalidLookupRef:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_InvalidLookupRef );
        ::CosTrading::InvalidLookupRef _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Link/DefaultFollowTooPermissive:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Link::_tc_DefaultFollowTooPermissive );
        ::CosTrading::Link::DefaultFollowTooPermissive _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Link/LimitingFollowTooPermissive:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Link::_tc_LimitingFollowTooPermissive );
        ::CosTrading::Link::LimitingFollowTooPermissive _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
void CosTrading::Link_stub::remove_link( const char* name )
{
  CORBA::Request_var _req = this->_request( "remove_link" );
  _req->add_in_arg( "name" ) <<= CORBA::Any::from_string( (char *) name, 0 );
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    if( _uuex ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Link/UnknownLinkName:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Link::_tc_UnknownLinkName );
        ::CosTrading::Link::UnknownLinkName _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
CosTrading::Link::LinkInfo* CosTrading::Link_stub::describe_link( const char* name )
{
  CORBA::Request_var _req = this->_request( "describe_link" );
  _req->add_in_arg( "name" ) <<= CORBA::Any::from_string( (char *) name, 0 );
  _req->result()->value()->type( CosTrading::Link::_tc_LinkInfo );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Link::LinkInfo* _res = new ::CosTrading::Link::LinkInfo;
  *_req->result()->value() >>= *_res;
  return _res;
}


CosTrading::LinkNameSeq* CosTrading::Link_stub::list_links()
{
  CORBA::Request_var _req = this->_request( "list_links" );
  _req->result()->value()->type( CosTrading::_tc_LinkNameSeq );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::LinkNameSeq* _res = new ::CosTrading::LinkNameSeq;
  *_req->result()->value() >>= *_res;
  return _res;
}


void CosTrading::Link_stub::modify_link( const char* name, CosTrading::FollowOption def_pass_on_follow_rule, CosTrading::FollowOption limiting_follow_rule )
{
  CORBA::Request_var _req = this->_request( "modify_link" );
  _req->add_in_arg( "name" ) <<= CORBA::Any::from_string( (char *) name, 0 );
  _req->add_in_arg( "def_pass_on_follow_rule" ) <<= def_pass_on_follow_rule;
  _req->add_in_arg( "limiting_follow_rule" ) <<= limiting_follow_rule;
  _req->result()->value()->type( CORBA::_tc_void );
...
struct _global_init_CosTrading_Link {
  _global_init_CosTrading_Link()
  {
    if( ::CosTrading::TraderComponents::_narrow_helpers == NULL )
      ::CosTrading::TraderComponents::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::TraderComponents::_narrow_helpers->push_back( CosTrading::Link::_narrow_helper2 );
    if( ::CosTrading::SupportAttributes::_narrow_helpers == NULL )
      ::CosTrading::SupportAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::SupportAttributes::_narrow_helpers->push_back( CosTrading::Link::_narrow_helper2 );
    if( ::CosTrading::LinkAttributes::_narrow_helpers == NULL )
      ::CosTrading::LinkAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::LinkAttributes::_narrow_helpers->push_back( CosTrading::Link::_narrow_helper2 );
  }
} __global_init_CosTrading_Link;
...
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Proxy::_tc_ConstraintRecipe; };
#else
CORBA::TypeCodeConst CosTrading::Proxy::_tc_ConstraintRecipe;
#endif

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Proxy::_tc_ProxyInfo; };
#else
CORBA::TypeCodeConst CosTrading::Proxy::_tc_ProxyInfo;
#endif

#ifdef HAVE_EXPLICIT_STRUCT_OPS
CosTrading::Proxy::ProxyInfo::ProxyInfo()
{
}

CosTrading::Proxy::ProxyInfo::ProxyInfo( const ProxyInfo& _s )
{
  type = ((ProxyInfo&)_s).type;
  target = ((ProxyInfo&)_s).target;
  properties = ((ProxyInfo&)_s).properties;
  if_match_all = ((ProxyInfo&)_s).if_match_all;
  recipe = ((ProxyInfo&)_s).recipe;
  policies_to_pass_on = ((ProxyInfo&)_s).policies_to_pass_on;
}
...
CosTrading::Proxy::ProxyInfo::operator=( const ProxyInfo& _s )
{
  type = ((ProxyInfo&)_s).type;
  target = ((ProxyInfo&)_s).target;
  properties = ((ProxyInfo&)_s).properties;
...
{
  _a.type( CosTrading::Proxy::_tc_ProxyInfo );
  return (_a.struct_put_begin() &&
    (_a <<= ((CosTrading::Proxy::ProxyInfo&)_s).type) &&
    (_a <<= (CosTrading::Lookup_ptr) ((CosTrading::Proxy::ProxyInfo&)_s).target) &&
    (_a <<= ((CosTrading::Proxy::ProxyInfo&)_s).properties) &&
    (_a <<= CORBA::Any::from_boolean( ((CosTrading::Proxy::ProxyInfo&)_s).if_match_all )) &&
    (_a <<= ((CosTrading::Proxy::ProxyInfo&)_s).recipe) &&
    (_a <<= ((CosTrading::Proxy::ProxyInfo&)_s).policies_to_pass_on) &&
    _a.struct_put_end() );
}
...
CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Proxy::ProxyInfo &_s )
{
  return (_a.struct_get_begin() &&
    ...
    (_a >>= (CosTrading::Lookup_ptr&) _s.target) &&
    (_a >>= _s.properties) &&
    (_a >>= CORBA::Any::to_boolean( _s.if_match_all )) &&
    (_a >>= _s.recipe) &&
    (_a >>= _s.policies_to_pass_on) &&
    _a.struct_get_end() );
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Proxy::_tc_IllegalRecipe; };
#else
CORBA::TypeCodeConst CosTrading::Proxy::_tc_IllegalRecipe;
#endif
...
CosTrading::Proxy::IllegalRecipe::IllegalRecipe( const IllegalRecipe& _s )
{
  recipe = ((IllegalRecipe&)_s).recipe;
}
...
CosTrading::Proxy::IllegalRecipe::operator=( const IllegalRecipe& _s )
{
  recipe = ((IllegalRecipe&)_s).recipe;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Proxy::IllegalRecipe &_e )
{
  _a.type( CosTrading::Proxy::_tc_IllegalRecipe );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Proxy/IllegalRecipe:1.0" ) &&
    (_a <<= ((CosTrading::Proxy::IllegalRecipe&)_e).recipe) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Proxy::IllegalRecipe &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.recipe) &&
...
void CosTrading::Proxy::IllegalRecipe::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw IllegalRecipe_var( (CosTrading::Proxy::IllegalRecipe*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Proxy::IllegalRecipe::_repoid() const
{
  return "IDL:omg.org/CosTrading/Proxy/IllegalRecipe:1.0";
}

void CosTrading::Proxy::IllegalRecipe::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Proxy::IllegalRecipe::_clone() const
{
  return new IllegalRecipe( *this );
}

CosTrading::Proxy::IllegalRecipe *CosTrading::Proxy::IllegalRecipe::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Proxy/IllegalRecipe:1.0" ) )
    return (IllegalRecipe *) _ex;
  return NULL;
}

#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst Proxy::_tc_NotProxyOfferId; };
#else
CORBA::TypeCodeConst CosTrading::Proxy::_tc_NotProxyOfferId;
#endif
...
CosTrading::Proxy::NotProxyOfferId::NotProxyOfferId( const NotProxyOfferId& _s )
{
  id = ((NotProxyOfferId&)_s).id;
}
...
CosTrading::Proxy::NotProxyOfferId::operator=( const NotProxyOfferId& _s )
{
  id = ((NotProxyOfferId&)_s).id;
  return *this;
}
...
CORBA::Boolean operator<<=( CORBA::Any &_a, const CosTrading::Proxy::NotProxyOfferId &_e )
{
  _a.type( CosTrading::Proxy::_tc_NotProxyOfferId );
  return (_a.except_put_begin( "IDL:omg.org/CosTrading/Proxy/NotProxyOfferId:1.0" ) &&
    (_a <<= ((CosTrading::Proxy::NotProxyOfferId&)_e).id) &&
    _a.except_put_end() );
}

CORBA::Boolean operator>>=( const CORBA::Any &_a, CosTrading::Proxy::NotProxyOfferId &_e )
{
  CORBA::String_var _repoid;
  return (_a.except_get_begin( _repoid ) &&
    (_a >>= _e.id) &&
...
void CosTrading::Proxy::NotProxyOfferId::_throwit() const
{
  #ifdef HAVE_EXCEPTIONS
  throw NotProxyOfferId_var( (CosTrading::Proxy::NotProxyOfferId*)_clone() );
  #else
  CORBA::Exception::_throw_failed( _clone() );
  #endif
}

const char *CosTrading::Proxy::NotProxyOfferId::_repoid() const
{
  return "IDL:omg.org/CosTrading/Proxy/NotProxyOfferId:1.0";
}

void CosTrading::Proxy::NotProxyOfferId::_encode( CORBA::DataEncoder &_en ) const
{
  CORBA::Any _a;
  _a <<= *this;
  _a.marshal( _en );
...
CORBA::Exception *CosTrading::Proxy::NotProxyOfferId::_clone() const
{
  return new NotProxyOfferId( *this );
}

CosTrading::Proxy::NotProxyOfferId *CosTrading::Proxy::NotProxyOfferId::_narrow( CORBA::Exception *_ex )
{
  if( _ex && !strcmp( _ex->_repoid(), "IDL:omg.org/CosTrading/Proxy/NotProxyOfferId:1.0" ) )
    return (NotProxyOfferId *) _ex;
  return NULL;
}
...
CosTrading::Proxy_stub::~Proxy_stub()
{
}

char* CosTrading::Proxy_stub::export_proxy( CosTrading::Lookup_ptr target, const char* type, const CosTrading::PropertySeq& properties, CORBA::Boolean if_match_all, const char* recipe, const CosTrading::PolicySeq& policies_to_pass_on )
{
  CORBA::Request_var _req = this->_request( "export_proxy" );
  _req->add_in_arg( "target" ) <<= (CosTrading::Lookup_ptr) target;
  _req->add_in_arg( "type" ) <<= CORBA::Any::from_string( (char *) type, 0 );
  _req->add_in_arg( "properties" ) <<= properties;
  _req->add_in_arg( "if_match_all" ) <<= CORBA::Any::from_boolean( if_match_all );
  _req->add_in_arg( "recipe" ) <<= CORBA::Any::from_string( (char *) recipe, 0 );
  _req->add_in_arg( "policies_to_pass_on" ) <<= policies_to_pass_on;
  _req->result()->value()->type( CosTrading::_tc_OfferId );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    if( _uuex ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Proxy/IllegalRecipe:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Proxy::_tc_IllegalRecipe );
        ::CosTrading::Proxy::IllegalRecipe _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/DuplicatePropertyName:1.0" ) ) {
...
void CosTrading::Proxy_stub::withdraw_proxy( const char* id )
{
  CORBA::Request_var _req = this->_request( "withdraw_proxy" );
  _req->add_in_arg( "id" ) <<= CORBA::Any::from_string( (char *) id, 0 );
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    if( _uuex ) {
      ...
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/Proxy/NotProxyOfferId:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::Proxy::_tc_NotProxyOfferId );
        ::CosTrading::Proxy::NotProxyOfferId _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
CosTrading::Proxy::ProxyInfo* CosTrading::Proxy_stub::describe_proxy( const char* id )
{
  CORBA::Request_var _req = this->_request( "describe_proxy" );
  _req->add_in_arg( "id" ) <<= CORBA::Any::from_string( (char *) id, 0 );
  _req->result()->value()->type( CosTrading::Proxy::_tc_ProxyInfo );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Proxy::ProxyInfo* _res = new ::CosTrading::Proxy::ProxyInfo;
  *_req->result()->value() >>= *_res;
  return _res;
}


struct _global_init_CosTrading_Proxy {
  _global_init_CosTrading_Proxy()
  {
    if( ::CosTrading::TraderComponents::_narrow_helpers == NULL )
      ::CosTrading::TraderComponents::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::TraderComponents::_narrow_helpers->push_back( CosTrading::Proxy::_narrow_helper2 );
    if( ::CosTrading::SupportAttributes::_narrow_helpers == NULL )
      ::CosTrading::SupportAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::SupportAttributes::_narrow_helpers->push_back( CosTrading::Proxy::_narrow_helper2 );
  }
} __global_init_CosTrading_Proxy;
...
CosTrading::Admin::OctetSeq* CosTrading::Admin_stub::request_id_stem()
{
  CORBA::Request_var _req = this->_request( "_get_request_id_stem" );
  _req->result()->value()->type( CosTrading::Admin::_tc_OctetSeq );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    CORBA::Exception *_ex = _req->env()->exception();
  ...
  #endif
  CosTrading::Admin::OctetSeq* _res = new ::CosTrading::Admin::OctetSeq;
  *_req->result()->value() >>= *_res;
  return _res;
}


CosTrading::Admin_stub::~Admin_stub()
{
}

CORBA::ULong CosTrading::Admin_stub::set_def_search_card( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_def_search_card" );
...
CORBA::ULong CosTrading::Admin_stub::set_max_search_card( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_max_search_card" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_def_match_card( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_def_match_card" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_max_match_card( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_max_match_card" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_def_return_card( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_def_return_card" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_max_return_card( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_max_return_card" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_max_list( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_max_list" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::Boolean CosTrading::Admin_stub::set_supports_modifiable_properties( CORBA::Boolean value )
{
  CORBA::Request_var _req = this->_request( "set_supports_modifiable_properties" );
  _req->add_in_arg( "value" ) <<= CORBA::Any::from_boolean( value );
  _req->result()->value()->type( CORBA::_tc_boolean );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CORBA::Boolean CosTrading::Admin_stub::set_supports_dynamic_properties( CORBA::Boolean value )
{
  CORBA::Request_var _req = this->_request( "set_supports_dynamic_properties" );
  _req->add_in_arg( "value" ) <<= CORBA::Any::from_boolean( value );
  _req->result()->value()->type( CORBA::_tc_boolean );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::Boolean CosTrading::Admin_stub::set_supports_proxy_offers( CORBA::Boolean value )
{
  CORBA::Request_var _req = this->_request( "set_supports_proxy_offers" );
  _req->add_in_arg( "value" ) <<= CORBA::Any::from_boolean( value );
  _req->result()->value()->type( CORBA::_tc_boolean );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_def_hop_count( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_def_hop_count" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CORBA::ULong CosTrading::Admin_stub::set_max_hop_count( CORBA::ULong value )
{
  CORBA::Request_var _req = this->_request( "set_max_hop_count" );
  _req->add_in_arg( "value" ) <<= value;
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CosTrading::FollowOption CosTrading::Admin_stub::set_def_follow_policy( CosTrading::FollowOption policy )
{
  CORBA::Request_var _req = this->_request( "set_def_follow_policy" );
  _req->add_in_arg( "policy" ) <<= policy;
  _req->result()->value()->type( CosTrading::_tc_FollowOption );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CosTrading::FollowOption CosTrading::Admin_stub::set_max_follow_policy( CosTrading::FollowOption policy )
{
  CORBA::Request_var _req = this->_request( "set_max_follow_policy" );
  _req->add_in_arg( "policy" ) <<= policy;
  _req->result()->value()->type( CosTrading::_tc_FollowOption );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CosTrading::FollowOption CosTrading::Admin_stub::set_max_link_follow_policy( CosTrading::FollowOption policy )
{
  CORBA::Request_var _req = this->_request( "set_max_link_follow_policy" );
  _req->add_in_arg( "policy" ) <<= policy;
  _req->result()->value()->type( CosTrading::_tc_FollowOption );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
...
CosTrading::TypeRepository_ptr CosTrading::Admin_stub::set_type_repos( CosTrading::TypeRepository_ptr repository )
{
  CORBA::Request_var _req = this->_request( "set_type_repos" );
  _req->add_in_arg( "repository" ) <<= CORBA::Any::from_object( repository, "Object" );
  _req->result()->value()->type( CosTrading::_tc_TypeRepository );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
CosTrading::Admin::OctetSeq* CosTrading::Admin_stub::set_request_id_stem( const CosTrading::Admin::OctetSeq& stem )
{
  CORBA::Request_var _req = this->_request( "set_request_id_stem" );
  _req->add_in_arg( "stem" ) <<= stem;
  _req->result()->value()->type( CosTrading::Admin::_tc_OctetSeq );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
...
void CosTrading::Admin_stub::list_offers( CORBA::ULong how_many, CosTrading::OfferIdSeq*& ids, CosTrading::OfferIdIterator_ptr& id_itr )
{
  CORBA::Request_var _req = this->_request( "list_offers" );
  _req->add_in_arg( "how_many" ) <<= how_many;
  _req->add_out_arg( "ids" );
  _req->arguments()->item( 1 )->value()->type( CosTrading::_tc_OfferIdSeq );
  _req->add_out_arg( "id_itr" );
  _req->arguments()->item( 2 )->value()->type( CosTrading::_tc_OfferIdIterator );
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
  ...
  #endif
  ids = new ::CosTrading::OfferIdSeq;
  *_req->arguments()->item( 1 )->value() >>= *ids;
  *_req->arguments()->item( 2 )->value() >>= (CosTrading::OfferIdIterator_ptr&) id_itr;
}


void CosTrading::Admin_stub::list_proxies( CORBA::ULong how_many, CosTrading::OfferIdSeq*& ids, CosTrading::OfferIdIterator_ptr& id_itr )
{
  CORBA::Request_var _req = this->_request( "list_proxies" );
  _req->add_in_arg( "how_many" ) <<= how_many;
  _req->add_out_arg( "ids" );
  _req->arguments()->item( 1 )->value()->type( CosTrading::_tc_OfferIdSeq );
  _req->add_out_arg( "id_itr" );
...
struct _global_init_CosTrading_Admin {
  _global_init_CosTrading_Admin()
  {
    if( ::CosTrading::TraderComponents::_narrow_helpers == NULL )
      ::CosTrading::TraderComponents::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::TraderComponents::_narrow_helpers->push_back( CosTrading::Admin::_narrow_helper2 );
    if( ::CosTrading::SupportAttributes::_narrow_helpers == NULL )
      ::CosTrading::SupportAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::SupportAttributes::_narrow_helpers->push_back( CosTrading::Admin::_narrow_helper2 );
    if( ::CosTrading::ImportAttributes::_narrow_helpers == NULL )
      ::CosTrading::ImportAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::ImportAttributes::_narrow_helpers->push_back( CosTrading::Admin::_narrow_helper2 );
    if( ::CosTrading::LinkAttributes::_narrow_helpers == NULL )
      ::CosTrading::LinkAttributes::_narrow_helpers = new vector<CORBA::Narrow_proto>;
    ::CosTrading::LinkAttributes::_narrow_helpers->push_back( CosTrading::Admin::_narrow_helper2 );
  }
} __global_init_CosTrading_Admin;
...
CosTrading::OfferIterator_stub::~OfferIterator_stub()
{
}

CORBA::ULong CosTrading::OfferIterator_stub::max_left()
{
  CORBA::Request_var _req = this->_request( "max_left" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
    ...
    CORBA::UnknownUserException *_uuex = CORBA::UnknownUserException::_narrow( _ex );
    if( _uuex ) {
      if( !strcmp( _uuex->_except_repoid(), "IDL:omg.org/CosTrading/UnknownMaxLeft:1.0" ) ) {
        CORBA::Any &_a = _uuex->exception( ::CosTrading::_tc_UnknownMaxLeft );
        ::CosTrading::UnknownMaxLeft _user_ex;
        _a >>= _user_ex;
        mico_throw( _user_ex );
      }
      mico_throw( CORBA::UNKNOWN() );
...
CORBA::Boolean CosTrading::OfferIterator_stub::next_n( CORBA::ULong n, CosTrading::OfferSeq*& offers )
{
  CORBA::Request_var _req = this->_request( "next_n" );
  _req->add_in_arg( "n" ) <<= n;
  _req->add_out_arg( "offers" );
  _req->arguments()->item( 1 )->value()->type( CosTrading::_tc_OfferSeq );
  _req->result()->value()->type( CORBA::_tc_boolean );
  _req->invoke();
  #ifdef HAVE_EXCEPTIONS
  if( _req->env()->exception() ) {
  ...
  #endif
  offers = new ::CosTrading::OfferSeq;
  *_req->arguments()->item( 1 )->value() >>= *offers;
  CORBA::Boolean _res;
  *_req->result()->value() >>= CORBA::Any::to_boolean( _res );
  return _res;
}
...
void CosTrading::OfferIterator_stub::destroy()
{
...
// Stub interface OfferIdIterator
CosTrading::OfferIdIterator::~OfferIdIterator()
{
}

CosTrading::OfferIdIterator_ptr CosTrading::OfferIdIterator::_duplicate( OfferIdIterator_ptr _obj )
{
  if( !CORBA::is_nil( _obj ) )
    _obj->_ref();
  return _obj;
...
void *CosTrading::OfferIdIterator::_narrow_helper( const char *_repoid )
{
  if( strcmp( _repoid, "IDL:omg.org/CosTrading/OfferIdIterator:1.0" ) == 0 )
    return (void *)this;
  return NULL;
}

bool CosTrading::OfferIdIterator::_narrow_helper2( CORBA::Object_ptr _obj )
{
  if( strcmp( _obj->_repoid(), "IDL:omg.org/CosTrading/OfferIdIterator:1.0" ) == 0) {
    return true;
  }
  for( vector<CORBA::Narrow_proto>::size_type _i = 0;
       _narrow_helpers && _i < _narrow_helpers->size(); _i++ ) {
...
CosTrading::OfferIdIterator_ptr CosTrading::OfferIdIterator::_narrow( CORBA::Object_ptr _obj )
{
  CosTrading::OfferIdIterator_ptr _o;
  if( !CORBA::is_nil( _obj ) ) {
    void *_p;
    if( (_p = _obj->_narrow_helper( "IDL:omg.org/CosTrading/OfferIdIterator:1.0" )))
      return _duplicate( (CosTrading::OfferIdIterator_ptr) _p );
    if( _narrow_helper2( _obj ) ) {
      _o = new CosTrading::OfferIdIterator_stub;
      _o->CORBA::Object::operator=( *_obj );
      return _o;
    }
  }
...
CosTrading::OfferIdIterator_ptr CosTrading::OfferIdIterator::_nil()
{
  return NULL;
}

CosTrading::OfferIdIterator_stub::~OfferIdIterator_stub()
{
}

CORBA::ULong CosTrading::OfferIdIterator_stub::max_left()
{
  CORBA::Request_var _req = this->_request( "max_left" );
  _req->result()->value()->type( CORBA::_tc_ulong );
  _req->invoke();
...
CORBA::Boolean CosTrading::OfferIdIterator_stub::next_n( CORBA::ULong n, CosTrading::OfferIdSeq*& ids )
{
  CORBA::Request_var _req = this->_request( "next_n" );
  _req->add_in_arg( "n" ) <<= n;
  _req->add_out_arg( "ids" );
...
void CosTrading::OfferIdIterator_stub::destroy()
{
  CORBA::Request_var _req = this->_request( "destroy" );
  _req->result()->value()->type( CORBA::_tc_void );
  _req->invoke();
...
#ifdef HAVE_NAMESPACE
namespace CosTrading { vector<CORBA::Narrow_proto> * OfferIdIterator::_narrow_helpers; };
#else
vector<CORBA::Narrow_proto> * CosTrading::OfferIdIterator::_narrow_helpers;
#endif
#ifdef HAVE_NAMESPACE
namespace CosTrading { CORBA::TypeCodeConst _tc_OfferIdIterator; };
#else
CORBA::TypeCodeConst CosTrading::_tc_OfferIdIterator;
#endif

CORBA::Boolean
operator<<=( CORBA::Any &_a, const CosTrading::OfferIdIterator_ptr _obj )
{
  return (_a <<= CORBA::Any::from_object( _obj, "OfferIdIterator" ));
}

CORBA::Boolean
operator>>=( const CORBA::Any &_a, CosTrading::OfferIdIterator_ptr &_obj )
{
  CORBA::Object_ptr _o;
  if( !(_a >>= CORBA::Any::to_object( _o )) )
    return FALSE;
  if( CORBA::is_nil( _o ) ) {
    _obj = ::CosTrading::OfferIdIterator::_nil();
    return TRUE;
  }
  _obj = ::CosTrading::OfferIdIterator::_narrow( _o );
  CORBA::release( _o );
  return TRUE;
}
...
struct __tc_init_TRADER {
  __tc_init_TRADER()
  {
    ...
    "616c7761797300";
    CosTrading::_tc_LinkName = "010000001500000084000000010000002400000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b4e616d653a312e300009000000"
    "4c696e6b4e616d6500000000150000004000000001000000230000004944"
    "4c3a6f6d672e6f72672f436f7354726164696e672f49737472696e673a31"
    "2e3000000800000049737472696e67001200000000000000";
    CosTrading::_tc_LinkNameSeq = "0100000015000000dc000000010000002700000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b4e616d655365713a312e300000"
    "0c0000004c696e6b4e616d65536571001300000094000000010000001500"
    "000084000000010000002400000049444c3a6f6d672e6f72672f436f7354"
    "726164696e672f4c696e6b4e616d653a312e3000090000004c696e6b4e61"
    "6d65000000001500000040000000010000002300000049444c3a6f6d672e"
    "6f72672f436f7354726164696e672f49737472696e673a312e3000000800"
    "000049737472696e6700120000000000000000000000";
    CosTrading::_tc_TraderName = "010000001500000024010000010000002600000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f5472616465724e616d653a312e30000000"
    "0b0000005472616465724e616d65000015000000dc000000010000002700"
    "000049444c3a6f6d672e6f72672f436f7354726164696e672f4c696e6b4e"
    "616d655365713a312e3000000c0000004c696e6b4e616d65536571001300"
    "000094000000010000001500000084000000010000002400000049444c3a"
    "6f6d672e6f72672f436f7354726164696e672f4c696e6b4e616d653a312e"
    "3000090000004c696e6b4e616d6500000000150000004000000001000000"
    "2300000049444c3a6f6d672e6f72672f436f7354726164696e672f497374"
    "72696e673a312e3000000800000049737472696e67001200000000000000"
    "00000000";
    ...
    CosTrading::_tc_LinkAttributes = "010000000e00000047000000010000002a00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b417474726962757465733a312e"
    "300000000f0000004c696e6b4174747269627574657300";
    ...
    "4c6f6f6b757000";
    CosTrading::Register::_tc_OfferInfo = "010000000f000000fc020000010000002e00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f4f66666572496e66"
    "6f3a312e300000000a0000004f66666572496e666f000000030000000a00"
    "00007265666572656e63650000000e00000033000000010000001d000000"
    "49444c3a6f6d672e6f72672f434f5242412f4f626a6563743a312e300000"
    "0000070000004f626a656374000005000000747970650000000015000000"
    "90000000010000002b00000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f53657276696365547970654e616d653a312e30000010000000"
    "53657276696365547970654e616d65001500000040000000010000002300"
    "000049444c3a6f6d672e6f72672f436f7354726164696e672f4973747269"
    ...
    CosTrading::Register::_tc_UnknownPropertyName = "0100000016000000fc000000010000003800000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f556e6b6e6f776e50"
    "726f70657274794e616d653a312e300014000000556e6b6e6f776e50726f"
    "70657274794e616d650001000000050000006e616d650000000015000000"
    "8c000000010000002800000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f50726f70657274794e616d653a312e30000d00000050726f70"
    "657274794e616d6500000000150000004000000001000000230000004944"
    "4c3a6f6d672e6f72672f436f7354726164696e672f49737472696e673a31"
    ...
    "010000001d00000049444c3a6f6d672e6f72672f434f5242412f4f626a65"
    "63743a312e3000000000070000004f626a65637400";
    CosTrading::Register::_tc_ProxyOfferId = "0100000016000000a4000000010000003100000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f50726f78794f6666"
    "657249643a312e30000000000d00000050726f78794f6666657249640000"
    "000001000000030000006964000015000000400000000100000023000000"
    "49444c3a6f6d672e6f72672f436f7354726164696e672f4f666665724964"
    "3a312e300000080000004f666665724964001200000000000000";
    CosTrading::Register::_tc_MandatoryProperty = "0100000016000000a0010000010000003600000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f4d616e6461746f72"
    "7950726f70657274793a312e30000000120000004d616e6461746f727950"
    "726f70657274790000000200000005000000747970650000000015000000"
    "90000000010000002b00000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f53657276696365547970654e616d653a312e30000010000000"
    "53657276696365547970654e616d65001500000040000000010000002300"
    "000049444c3a6f6d672e6f72672f436f7354726164696e672f4973747269"
    ...
    "64696e672f49737472696e673a312e3000000800000049737472696e6700"
    "1200000000000000";
    CosTrading::Register::_tc_ReadonlyProperty = "0100000016000000a0010000010000003500000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f526561646f6e6c79"
    "50726f70657274793a312e300000000011000000526561646f6e6c795072"
    "6f7065727479000000000200000005000000747970650000000015000000"
    "90000000010000002b00000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f53657276696365547970654e616d653a312e30000010000000"
    "53657276696365547970654e616d65001500000040000000010000002300"
    "000049444c3a6f6d672e6f72672f436f7354726164696e672f4973747269"
    ...
    "64696e672f49737472696e673a312e3000000800000049737472696e6700"
    "1200000000000000";
    CosTrading::Register::_tc_NoMatchingOffers = "0100000016000000f8000000010000003500000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f4e6f4d6174636869"
    "6e674f66666572733a312e3000000000110000004e6f4d61746368696e67"
    "4f6666657273000000000100000007000000636f6e737472000015000000"
    "88000000010000002600000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f436f6e73747261696e743a312e300000000b000000436f6e73"
    "747261696e7400001500000040000000010000002300000049444c3a6f6d"
    "672e6f72672f436f7354726164696e672f49737472696e673a312e300000"
    "0800000049737472696e67001200000000000000";
    CosTrading::Register::_tc_IllegalTraderName = "010000001600000094010000010000003600000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f496c6c6567616c54"
    "72616465724e616d653a312e3000000012000000496c6c6567616c547261"
    "6465724e616d6500000001000000050000006e616d650000000015000000"
    "24010000010000002600000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f5472616465724e616d653a312e300000000b00000054726164"
    "65724e616d65000015000000dc000000010000002700000049444c3a6f6d"
    "672e6f72672f436f7354726164696e672f4c696e6b4e616d655365713a31"
    "2e3000000c0000004c696e6b4e616d655365710013000000940000000100"
    "00001500000084000000010000002400000049444c3a6f6d672e6f72672f"
    "436f7354726164696e672f4c696e6b4e616d653a312e3000090000004c69"
    "6e6b4e616d65000000001500000040000000010000002300000049444c3a"
    "6f6d672e6f72672f436f7354726164696e672f49737472696e673a312e30"
    "00000800000049737472696e6700120000000000000000000000";
    CosTrading::Register::_tc_UnknownTraderName = "010000001600000094010000010000003600000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f556e6b6e6f776e54"
    "72616465724e616d653a312e3000000012000000556e6b6e6f776e547261"
    "6465724e616d6500000001000000050000006e616d650000000015000000"
    "24010000010000002600000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f5472616465724e616d653a312e300000000b00000054726164"
    "65724e616d65000015000000dc000000010000002700000049444c3a6f6d"
    ...
    "6f6d672e6f72672f436f7354726164696e672f49737472696e673a312e30"
    "00000800000049737472696e6700120000000000000000000000";
    CosTrading::Register::_tc_RegisterNotSupported = "01000000160000009c010000010000003900000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f52656769737465722f5265676973746572"
    "4e6f74537570706f727465643a312e300000000015000000526567697374"
    "65724e6f74537570706f727465640000000001000000050000006e616d65"
    "000000001500000024010000010000002600000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f5472616465724e616d653a312e30000000"
    "0b0000005472616465724e616d65000015000000dc000000010000002700"
    "000049444c3a6f6d672e6f72672f436f7354726164696e672f4c696e6b4e"
    "616d655365713a312e3000000c0000004c696e6b4e616d65536571001300"
    ...
    "526567697374657200";
    CosTrading::Link::_tc_LinkInfo = "010000000f00000017020000010000002900000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b2f4c696e6b496e666f3a312e30"
    "00000000090000004c696e6b496e666f0000000004000000070000007461"
    "7267657400000e00000037000000010000002200000049444c3a6f6d672e"
    "6f72672f436f7354726164696e672f4c6f6f6b75703a312e300000000700"
    "00004c6f6f6b757000000b0000007461726765745f72656700000e000000"
    "39000000010000002400000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f52656769737465723a312e3000090000005265676973746572"
    "00000000180000006465665f706173735f6f6e5f666f6c6c6f775f72756c"
    "65001100000073000000010000002800000049444c3a6f6d672e6f72672f"
    "436f7354726164696e672f466f6c6c6f774f7074696f6e3a312e30000d00"
    "0000466f6c6c6f774f7074696f6e00000000030000000b0000006c6f6361"
    "6c5f6f6e6c7900000c00000069665f6e6f5f6c6f63616c0007000000616c"
    "776179730000150000006c696d6974696e675f666f6c6c6f775f72756c65"
    "000000001100000073000000010000002800000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f466f6c6c6f774f7074696f6e3a312e3000"
    "0d000000466f6c6c6f774f7074696f6e00000000030000000b0000006c6f"
    "63616c5f6f6e6c7900000c00000069665f6e6f5f6c6f63616c0007000000"
    "616c7761797300";
    CosTrading::Link::_tc_IllegalLinkName = "0100000016000000e8000000010000003000000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b2f496c6c6567616c4c696e6b4e"
    "616d653a312e300010000000496c6c6567616c4c696e6b4e616d65000100"
    "0000050000006e616d650000000015000000840000000100000024000000"
    "49444c3a6f6d672e6f72672f436f7354726164696e672f4c696e6b4e616d"
    "653a312e3000090000004c696e6b4e616d65000000001500000040000000"
    "010000002300000049444c3a6f6d672e6f72672f436f7354726164696e67"
    "2f49737472696e673a312e3000000800000049737472696e670012000000"
    "00000000";
    CosTrading::Link::_tc_UnknownLinkName = "0100000016000000e8000000010000003000000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b2f556e6b6e6f776e4c696e6b4e"
    "616d653a312e300010000000556e6b6e6f776e4c696e6b4e616d65000100"
    "0000050000006e616d650000000015000000840000000100000024000000"
    "49444c3a6f6d672e6f72672f436f7354726164696e672f4c696e6b4e616d"
    "653a312e3000090000004c696e6b4e616d65000000001500000040000000"
    "010000002300000049444c3a6f6d672e6f72672f436f7354726164696e67"
    "2f49737472696e673a312e3000000800000049737472696e670012000000"
    "00000000";
    CosTrading::Link::_tc_DuplicateLinkName = "0100000016000000f0000000010000003200000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b2f4475706c69636174654c696e"
    "6b4e616d653a312e30000000120000004475706c69636174654c696e6b4e"
    "616d6500000001000000050000006e616d65000000001500000084000000"
    "010000002400000049444c3a6f6d672e6f72672f436f7354726164696e67"
    "2f4c696e6b4e616d653a312e3000090000004c696e6b4e616d6500000000"
    "1500000040000000010000002300000049444c3a6f6d672e6f72672f436f"
    "7354726164696e672f49737472696e673a312e3000000800000049737472"
    "696e67001200000000000000";
    CosTrading::Link::_tc_DefaultFollowTooPermissive = "010000001600000097010000010000003b00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b2f44656661756c74466f6c6c6f"
    "77546f6f5065726d6973736976653a312e3000001b00000044656661756c"
    "74466f6c6c6f77546f6f5065726d69737369766500000200000018000000"
    "6465665f706173735f6f6e5f666f6c6c6f775f72756c6500110000007300"
    "0000010000002800000049444c3a6f6d672e6f72672f436f735472616469"
    "6e672f466f6c6c6f774f7074696f6e3a312e30000d000000466f6c6c6f77"
    "4f7074696f6e00000000030000000b0000006c6f63616c5f6f6e6c790000"
    "0c00000069665f6e6f5f6c6f63616c0007000000616c7761797300001500"
    "00006c696d6974696e675f666f6c6c6f775f72756c650000000011000000"
    "73000000010000002800000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f466f6c6c6f774f7074696f6e3a312e30000d000000466f6c6c"
    "6f774f7074696f6e00000000030000000b0000006c6f63616c5f6f6e6c79"
    "00000c00000069665f6e6f5f6c6f63616c0007000000616c7761797300";
    CosTrading::Link::_tc_LimitingFollowTooPermissive = "010000001600000097010000010000003c00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4c696e6b2f4c696d6974696e67466f6c6c"
    "6f77546f6f5065726d6973736976653a312e30001c0000004c696d697469"
    "6e67466f6c6c6f77546f6f5065726d697373697665000200000015000000"
    "6c696d6974696e675f666f6c6c6f775f72756c6500000000110000007300"
    "0000010000002800000049444c3a6f6d672e6f72672f436f735472616469"
    "6e672f466f6c6c6f774f7074696f6e3a312e30000d000000466f6c6c6f77"
    "4f7074696f6e00000000030000000b0000006c6f63616c5f6f6e6c790000"
    "0c00000069665f6e6f5f6c6f63616c0007000000616c7761797300001700"
    "00006d61785f6c696e6b5f666f6c6c6f775f706f6c696379000011000000"
    "73000000010000002800000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f466f6c6c6f774f7074696f6e3a312e30000d000000466f6c6c"
    "6f774f7074696f6e00000000030000000b0000006c6f63616c5f6f6e6c79"
    "00000c00000069665f6e6f5f6c6f63616c0007000000616c7761797300";
    ...
    "00";
    CosTrading::Proxy::_tc_ConstraintRecipe = "01000000150000009c000000010000003200000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f50726f78792f436f6e73747261696e7452"
    "65636970653a312e3000000011000000436f6e73747261696e7452656369"
    "7065000000001500000040000000010000002300000049444c3a6f6d672e"
    "6f72672f436f7354726164696e672f49737472696e673a312e3000000800"
    "000049737472696e67001200000000000000";
    CosTrading::Proxy::_tc_ProxyInfo = "010000000f00000028050000010000002b00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f50726f78792f50726f7879496e666f3a31"
    "2e3000000a00000050726f7879496e666f00000006000000050000007479"
    "7065000000001500000090000000010000002b00000049444c3a6f6d672e"
    "6f72672f436f7354726164696e672f53657276696365547970654e616d65"
    "3a312e3000001000000053657276696365547970654e616d650015000000"
    "40000000010000002300000049444c3a6f6d672e6f72672f436f73547261"
    "64696e672f49737472696e673a312e3000000800000049737472696e6700"
    "12000000000000000700000074617267657400000e000000370000000100"
    "00002200000049444c3a6f6d672e6f72672f436f7354726164696e672f4c"
    "6f6f6b75703a312e30000000070000004c6f6f6b757000000b0000007072"
    "6f70657274696573000015000000a8010000010000002700000049444c3a"
    "6f6d672e6f72672f436f7354726164696e672f50726f7065727479536571"
    "3a312e3000000c00000050726f7065727479536571001300000060010000"
    "010000000f00000050010000010000002400000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f50726f70657274793a312e300009000000"
    "50726f70657274790000000003000000050000006e616d65000000001500"
    "00008c000000010000002800000049444c3a6f6d672e6f72672f436f7354"
    "726164696e672f50726f70657274794e616d653a312e30000d0000005072"
    ...
    "672e6f72672f436f7354726164696e672f50726f706572747956616c7565"
    "3a312e30000000000e00000050726f706572747956616c75650000000b00"
    "00000800000069735f66696c650008000000000000000d00000069665f6d"
    "617463685f616c6c00000000080000000700000072656369706500001500"
    "00009c000000010000003200000049444c3a6f6d672e6f72672f436f7354"
    "726164696e672f50726f78792f436f6e73747261696e745265636970653a"
    "312e3000000011000000436f6e73747261696e7452656369706500000000"
    "1500000040000000010000002300000049444c3a6f6d672e6f72672f436f"
    "7354726164696e672f49737472696e673a312e3000000800000049737472"
    "696e6700120000000000000014000000706f6c69636965735f746f5f7061"
    "73735f6f6e001500000048010000010000002500000049444c3a6f6d672e"
    "6f72672f436f7354726164696e672f506f6c6963795365713a312e300000"
    "00000a000000506f6c696379536571000000130000000001000001000000"
    "0f000000f0000000010000002200000049444c3a6f6d672e6f72672f436f"
    "7354726164696e672f506f6c6963793a312e3000000007000000506f6c69"
    "6379000002000000050000006e616d650000000015000000480000000100"
    "00002600000049444c3a6f6d672e6f72672f436f7354726164696e672f50"
    ...
    "010000002700000049444c3a6f6d672e6f72672f436f7354726164696e67"
    "2f506f6c69637956616c75653a312e3000000c000000506f6c6963795661"
    "6c7565000b00000000000000";
    CosTrading::Proxy::_tc_IllegalRecipe = "010000001600000000010000010000002f00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f50726f78792f496c6c6567616c52656369"
    "70653a312e3000000e000000496c6c6567616c5265636970650000000100"
    "0000070000007265636970650000150000009c0000000100000032000000"
    "49444c3a6f6d672e6f72672f436f7354726164696e672f50726f78792f43"
    "6f6e73747261696e745265636970653a312e3000000011000000436f6e73"
    "747261696e74526563697065000000001500000040000000010000002300"
    "000049444c3a6f6d672e6f72672f436f7354726164696e672f4973747269"
    "6e673a312e3000000800000049737472696e67001200000000000000";
    CosTrading::Proxy::_tc_NotProxyOfferId = "0100000016000000a4000000010000003100000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f50726f78792f4e6f7450726f78794f6666"
    "657249643a312e3000000000100000004e6f7450726f78794f6666657249"
    "640001000000030000006964000015000000400000000100000023000000"
    "49444c3a6f6d672e6f72672f436f7354726164696e672f4f666665724964"
    "3a312e300000080000004f666665724964001200000000000000";
    ...
    CosTrading::_tc_OfferIdIterator = "010000000e00000048000000010000002b00000049444c3a6f6d672e6f72"
    "672f436f7354726164696e672f4f6666657249644974657261746f723a31"
    "2e300000100000004f6666657249644974657261746f7200";
...
// Dynamic Implementation Routine for interface LinkAttributes
CosTrading::LinkAttributes_skel::LinkAttributes_skel( const CORBA::BOA::ReferenceData &_id )
{
  CORBA::ImplementationDef_var _impl =
    _find_impl( "IDL:omg.org/CosTrading/LinkAttributes:1.0", "LinkAttributes" );
  assert( !CORBA::is_nil( _impl ) );
  _create_ref( _id,
    CORBA::InterfaceDef::_nil(),
    _impl,
    "IDL:omg.org/CosTrading/LinkAttributes:1.0" );
  register_dispatcher( new InterfaceDispatcherWrapper<LinkAttributes_skel>( this ) );
}

CosTrading::LinkAttributes_skel::LinkAttributes_skel( CORBA::Object_ptr _obj )
{
  CORBA::ImplementationDef_var _impl =
    _find_impl( "IDL:omg.org/CosTrading/LinkAttributes:1.0", "LinkAttributes" );
  assert( !CORBA::is_nil( _impl ) );
...
CosTrading::LinkAttributes_skel::~LinkAttributes_skel()
{
}

bool CosTrading::LinkAttributes_skel::dispatch( CORBA::ServerRequest_ptr _req, CORBA::Environment & /*_env*/ )
{
  if( strcmp( _req->op_name(), "_get_max_link_follow_policy" ) == 0 ) {
    CORBA::NVList_ptr _args = new CORBA::NVList (0);
...
CosTrading::LinkAttributes_ptr CosTrading::LinkAttributes_skel::_this()
{
  return CosTrading::LinkAttributes::_duplicate( this );
}
...
bool CosTrading::Register_skel::dispatch( CORBA::ServerRequest_ptr _req, CORBA::Environment & /*_env*/ )
{
  if( strcmp( _req->op_name(), "export" ) == 0 ) {
    ...
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CORBA::_tc_Object );
    _args->add( CORBA::ARG_IN );
    _args->item( 1 )->value()->type( CosTrading::_tc_ServiceTypeName );
    _args->add( CORBA::ARG_IN );
    _args->item( 2 )->value()->type( CosTrading::_tc_PropertySeq );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= CORBA::Any::to_object( reference );
    *_args->item( 1 )->value() >>= CORBA::Any::to_string( type, 0 );
    *_args->item( 2 )->value() >>= properties;
    OfferId _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = export( reference, type, properties );
    #ifdef HAVE_EXCEPTIONS
    } catch( ::CosTrading::Register::InvalidObjectRef_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::IllegalServiceType_var &_ex ) {
      _req->exception( _ex->_clone() );
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::InterfaceTypeMismatch_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::IllegalPropertyName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::PropertyTypeMismatch_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::ReadonlyDynamicProperty_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::MissingMandatoryProperty_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::DuplicatePropertyName_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "withdraw" ) == 0 ) {
    ...
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_OfferId );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= CORBA::Any::to_string( id, 0 );
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      withdraw( id );
    #ifdef HAVE_EXCEPTIONS
    } catch( ::CosTrading::IllegalOfferId_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::UnknownOfferId_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::ProxyOfferId_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "modify" ) == 0 ) {
    OfferId_var id;
    PropertyNameSeq del_list;
    PropertySeq modify_list;

    CORBA::NVList_ptr _args = new CORBA::NVList (3);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_OfferId );
    _args->add( CORBA::ARG_IN );
    _args->item( 1 )->value()->type( CosTrading::_tc_PropertyNameSeq );
    _args->add( CORBA::ARG_IN );
    _args->item( 2 )->value()->type( CosTrading::_tc_PropertySeq );
    ...
    *_args->item( 0 )->value() >>= CORBA::Any::to_string( id, 0 );
    *_args->item( 1 )->value() >>= del_list;
    *_args->item( 2 )->value() >>= modify_list;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      modify( id, del_list, modify_list );
    #ifdef HAVE_EXCEPTIONS
    } catch( ::CosTrading::NotImplemented_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::IllegalOfferId_var &_ex ) {
      _req->exception( _ex->_clone() );
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::UnknownPropertyName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::PropertyTypeMismatch_var &_ex ) {
      _req->exception( _ex->_clone() );
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::MandatoryProperty_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::ReadonlyProperty_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::DuplicatePropertyName_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "withdraw_using_constraint" ) == 0 ) {
    ServiceTypeName_var type;
    Constraint_var constr;
    ...
    *_args->item( 1 )->value() >>= CORBA::Any::to_string( constr, 0 );
    ...
    try {
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::NoMatchingOffers_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "resolve" ) == 0 ) {
    TraderName name;

    CORBA::NVList_ptr _args = new CORBA::NVList (1);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_TraderName );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= name;
    ::CosTrading::Register_ptr _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = resolve( name );
    #ifdef HAVE_EXCEPTIONS
    } catch( ::CosTrading::Register::IllegalTraderName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::UnknownTraderName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Register::RegisterNotSupported_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
    ...
    #endif
    CORBA::Any *_any_res = new CORBA::Any;
    *_any_res <<= (::CosTrading::Register_ptr) _res;
    CORBA::release( _res );
    _req->result( _any_res );
    return true;
  }
...
{
  if( strcmp( _req->op_name(), "add_link" ) == 0 ) {
    LinkName_var name;
    Lookup_var target;
    ...
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_LinkName );
    _args->add( CORBA::ARG_IN );
    _args->item( 1 )->value()->type( CosTrading::_tc_Lookup );
    _args->add( CORBA::ARG_IN );
    _args->item( 2 )->value()->type( CosTrading::_tc_FollowOption );
    _args->add( CORBA::ARG_IN );
    _args->item( 3 )->value()->type( CosTrading::_tc_FollowOption );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= CORBA::Any::to_string( name, 0 );
    *_args->item( 1 )->value() >>= (Lookup_ptr&) target;
    *_args->item( 2 )->value() >>= def_pass_on_follow_rule;
    *_args->item( 3 )->value() >>= limiting_follow_rule;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      add_link( name, target, def_pass_on_follow_rule, limiting_follow_rule );
    #ifdef HAVE_EXCEPTIONS
    } catch( ::CosTrading::Link::IllegalLinkName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Link::DuplicateLinkName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::InvalidLookupRef_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Link::DefaultFollowTooPermissive_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Link::LimitingFollowTooPermissive_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "remove_link" ) == 0 ) {
    LinkName_var name;
    ...
    *_args->item( 0 )->value() >>= CORBA::Any::to_string( name, 0 );
    ...
    try {
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Link::UnknownLinkName_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "describe_link" ) == 0 ) {
    LinkName_var name;
  ...
  if( strcmp( _req->op_name(), "list_links" ) == 0 ) {
    CORBA::NVList_ptr _args = new CORBA::NVList (0);
  ...
  if( strcmp( _req->op_name(), "modify_link" ) == 0 ) {
    LinkName_var name;
    FollowOption def_pass_on_follow_rule;
    FollowOption limiting_follow_rule;
    ...
    _args->item( 0 )->value()->type( CosTrading::_tc_LinkName );
    _args->add( CORBA::ARG_IN );
    _args->item( 1 )->value()->type( CosTrading::_tc_FollowOption );
    _args->add( CORBA::ARG_IN );
    _args->item( 2 )->value()->type( CosTrading::_tc_FollowOption );
    ...
    *_args->item( 0 )->value() >>= CORBA::Any::to_string( name, 0 );
    *_args->item( 1 )->value() >>= def_pass_on_follow_rule;
    *_args->item( 2 )->value() >>= limiting_follow_rule;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
...
{
  if( strcmp( _req->op_name(), "export_proxy" ) == 0 ) {
    Lookup_var target;
    ServiceTypeName_var type;
    PropertySeq properties;
    ...
    CORBA::NVList_ptr _args = new CORBA::NVList (6);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_Lookup );
    _args->add( CORBA::ARG_IN );
    _args->item( 1 )->value()->type( CosTrading::_tc_ServiceTypeName );
    _args->add( CORBA::ARG_IN );
    _args->item( 2 )->value()->type( CosTrading::_tc_PropertySeq );
    ...
    _args->add( CORBA::ARG_IN );
    _args->item( 4 )->value()->type( CosTrading::Proxy::_tc_ConstraintRecipe );
    _args->add( CORBA::ARG_IN );
    _args->item( 5 )->value()->type( CosTrading::_tc_PolicySeq );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= (Lookup_ptr&) target;
    *_args->item( 1 )->value() >>= CORBA::Any::to_string( type, 0 );
    *_args->item( 2 )->value() >>= properties;
    *_args->item( 3 )->value() >>= CORBA::Any::to_boolean( if_match_all );
    *_args->item( 4 )->value() >>= CORBA::Any::to_string( recipe, 0 );
    *_args->item( 5 )->value() >>= policies_to_pass_on;
    OfferId _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = export_proxy( target, type, properties, if_match_all, recipe, policies_to_pass_on );
    #ifdef HAVE_EXCEPTIONS
    } catch( ::CosTrading::IllegalServiceType_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Proxy::IllegalRecipe_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::DuplicatePropertyName_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "withdraw_proxy" ) == 0 ) {
    OfferId_var id;
    ...
    *_args->item( 0 )->value() >>= CORBA::Any::to_string( id, 0 );
    ...
    try {
      ...
      _req->exception( _ex->_clone() );
      return true;
    } catch( ::CosTrading::Proxy::NotProxyOfferId_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
  ...
  if( strcmp( _req->op_name(), "describe_proxy" ) == 0 ) {
    OfferId_var id;
...
{
  if( strcmp( _req->op_name(), "_get_request_id_stem" ) == 0 ) {
    CORBA::NVList_ptr _args = new CORBA::NVList (0);
  ...
  if( strcmp( _req->op_name(), "set_def_search_card" ) == 0 ) {
    CORBA::ULong value;
    ...
    *_args->item( 0 )->value() >>= value;
    CORBA::ULong _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = set_def_search_card( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_max_search_card" ) == 0 ) {
    CORBA::ULong value;
    ...
    *_args->item( 0 )->value() >>= value;
    ...
    try {
    #endif
      _res = set_max_search_card( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_def_match_card" ) == 0 ) {
    CORBA::ULong value;
  ...
  if( strcmp( _req->op_name(), "set_max_match_card" ) == 0 ) {
    CORBA::ULong value;
  ...
  if( strcmp( _req->op_name(), "set_def_return_card" ) == 0 ) {
    CORBA::ULong value;
    ...
    *_args->item( 0 )->value() >>= value;
    ...
    try {
    #endif
      _res = set_def_return_card( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_max_return_card" ) == 0 ) {
    CORBA::ULong value;
    ...
    *_args->item( 0 )->value() >>= value;
    ...
    try {
    #endif
      _res = set_max_return_card( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_max_list" ) == 0 ) {
    CORBA::ULong value;
  ...
  if( strcmp( _req->op_name(), "set_supports_modifiable_properties" ) == 0 ) {
    CORBA::Boolean value;

    CORBA::NVList_ptr _args = new CORBA::NVList (1);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CORBA::_tc_boolean );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= CORBA::Any::to_boolean( value );
    CORBA::Boolean _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = set_supports_modifiable_properties( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_supports_dynamic_properties" ) == 0 ) {
    CORBA::Boolean value;
    ...
    *_args->item( 0 )->value() >>= CORBA::Any::to_boolean( value );
    ...
    try {
    #endif
      _res = set_supports_dynamic_properties( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_supports_proxy_offers" ) == 0 ) {
    CORBA::Boolean value;
    ...
    *_args->item( 0 )->value() >>= CORBA::Any::to_boolean( value );
    ...
    try {
    #endif
      _res = set_supports_proxy_offers( value );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_def_hop_count" ) == 0 ) {
    CORBA::ULong value;
  ...
  if( strcmp( _req->op_name(), "set_max_hop_count" ) == 0 ) {
    CORBA::ULong value;
  ...
  if( strcmp( _req->op_name(), "set_def_follow_policy" ) == 0 ) {
    FollowOption policy;

    CORBA::NVList_ptr _args = new CORBA::NVList (1);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_FollowOption );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= policy;
    FollowOption _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = set_def_follow_policy( policy );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_max_follow_policy" ) == 0 ) {
    FollowOption policy;
    ...
    *_args->item( 0 )->value() >>= policy;
    ...
    try {
    #endif
      _res = set_max_follow_policy( policy );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_max_link_follow_policy" ) == 0 ) {
    FollowOption policy;
    ...
    *_args->item( 0 )->value() >>= policy;
    ...
    try {
    #endif
      _res = set_max_link_follow_policy( policy );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_type_repos" ) == 0 ) {
    TypeRepository_var repository;

    CORBA::NVList_ptr _args = new CORBA::NVList (1);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::_tc_TypeRepository );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= CORBA::Any::to_object( repository );
    TypeRepository_ptr _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = set_type_repos( repository );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "set_request_id_stem" ) == 0 ) {
    OctetSeq stem;

    CORBA::NVList_ptr _args = new CORBA::NVList (1);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CosTrading::Admin::_tc_OctetSeq );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= stem;
    OctetSeq* _res;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
      _res = set_request_id_stem( stem );
    #ifdef HAVE_EXCEPTIONS
    } catch( CORBA::SystemException_var &_ex ) {
      _req->exception( _ex->_clone() );
      return true;
  ...
  if( strcmp( _req->op_name(), "list_offers" ) == 0 ) {
    CORBA::ULong how_many;
    OfferIdSeq* ids;
    OfferIdIterator_ptr id_itr;

    CORBA::NVList_ptr _args = new CORBA::NVList (3);
    _args->add( CORBA::ARG_IN );
    _args->item( 0 )->value()->type( CORBA::_tc_ulong );
    _args->add( CORBA::ARG_OUT );
    _args->item( 1 )->value()->type( CosTrading::_tc_OfferIdSeq );
    _args->add( CORBA::ARG_OUT );
    _args->item( 2 )->value()->type( CosTrading::_tc_OfferIdIterator );

    if (!_req->params( _args ))
      return true;

    *_args->item( 0 )->value() >>= how_many;
    #ifdef HAVE_EXCEPTIONS
    try {
    #endif
    ...
    #endif
    *_args->item( 1 )->value() <<= *ids;
    delete ids;
    *_args->item( 2 )->value() <<= (OfferIdIterator_ptr) id_itr;
    CORBA::release( id_itr );
    return true;
  }
  if( strcmp( _req->op_name(), "list_proxies" ) == 0 ) {
    CORBA::ULong how_many;
    OfferIdSeq* ids;
    OfferIdIterator_ptr id_itr;
...
// Dynamic Implementation Routine for interface OfferIdIterator
CosTrading::OfferIdIterator_skel::OfferIdIterator_skel( const CORBA::BOA::ReferenceData &_id )
{
  CORBA::ImplementationDef_var _impl =
    _find_impl( "IDL:omg.org/CosTrading/OfferIdIterator:1.0", "OfferIdIterator" );
  assert( !CORBA::is_nil( _impl ) );
  _create_ref( _id,
    CORBA::InterfaceDef::_nil(),
    _impl,
    "IDL:omg.org/CosTrading/OfferIdIterator:1.0" );
  register_dispatcher( new InterfaceDispatcherWrapper<OfferIdIterator_skel>( this ) );
}

CosTrading::OfferIdIterator_skel::OfferIdIterator_skel( CORBA::Object_ptr _obj )
{
  CORBA::ImplementationDef_var _impl =
    _find_impl( "IDL:omg.org/CosTrading/OfferIdIterator:1.0", "OfferIdIterator" );
  assert( !CORBA::is_nil( _impl ) );
...
CosTrading::OfferIdIterator_skel::~OfferIdIterator_skel()
{
}

bool CosTrading::OfferIdIterator_skel::dispatch( CORBA::ServerRequest_ptr _req, CORBA::Environment & /*_env*/ )
{
  if( strcmp( _req->op_name(), "max_left" ) == 0 ) {
    CORBA::NVList_ptr _args = new CORBA::NVList (0);
...
CosTrading::OfferIdIterator_ptr CosTrading::OfferIdIterator_skel::_this()
{
  return CosTrading::OfferIdIterator::_duplicate( this );
}
